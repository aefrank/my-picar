...
from bicycle_model import BicyclePose




#################################################################
#       Going btw BicyclePose and CartesianPose objects      #
#################################################################


def cartesian2bicycle(robot_cartesian, goal_cartesian):
    '''
    ...
    return BicyclePose(rho,alpha,beta)
...
def test():
    ...
    # robot_cartesian = CartesianPose(4,8,3*pi/4)
    # goal_cartesian = CartesianPose(9,3,pi/4)
    # print("Robot in cartesian ref frame: {}\nGoal in cartesian ref frame: {}".format(
    #     robot_cartesian,goal_cartesian))


    # # print(goal_wrt(robot_cartesian))
